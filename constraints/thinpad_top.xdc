...
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets clk_50M]
...
set_false_path -from [get_clocks clk_50M] -to [get_clocks -of_objects [get_pins use_pll_in_simulation.reset_sync/clock_gen/inst/mmcm_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks -of_objects [get_pins use_pll_in_simulation.reset_sync/clock_gen/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks clk_50M]
# set_input_delay -clock [get_clocks -of_objects [get_pins use_pll_in_simulation.reset_sync/clock_gen/inst/clk_in1] )
